...
dynamics = Parameterization(
    ...
    hamiltonian_amplitudes=[1e-3, 1e-5, 1e-6],
    lindblad_amplitudes=[1e-6, 1e-6, 1e-7],
    seed = 0 
)
...
for i in range(ITERATIONS_SME):
    ...
    print(f"Iteration {i:03d} - Loss: {loss:.6e}")
